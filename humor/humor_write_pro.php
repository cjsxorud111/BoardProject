<?php
    ...
    $sql = "INSERT INTO humor(nickname, password, description,title)VALUES('".$_POST['nickname']."','".$_POST['password']."','".$_POST['description']."','".$_POST['title']."')";
...
//    }
echo "<script>
        window.location.href = 'gesi_humor.php?name=1';
      </script>"; 
?>
