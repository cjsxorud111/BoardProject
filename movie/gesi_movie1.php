          ...
          <div id="best">
             <div id="gesigle">
                 ...
                 <?php
                    ...
                    $sql = "SELECT * FROM movie WHERE num>0 order by num desc limit $limit_first, $onepage";
                    $result = mysqli_query($conn, $sql); 
                    ...
                    <p id="mun"> 
                    <tu id="g"><?=$row['num']?></tu>
                    <a href="description.php?nickname=<?=$row['nickname']?>&title=<?=$row['title']?>&num=<?=$row['num']?>" id="gle" ><?=$row['title']?></a>
                    ...
                    ?>
                    <foosster id="foott">
                        <pp><? include ("movie_main_paging.php"); ?></pp> <!--list_page1.php연결-->

                        <a href="gesi_movwrite.php" id="wri">글쓰기</a>
                    </foosster>
             </div>
